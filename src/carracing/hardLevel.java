...
public class hardLevel implements ActionListener, KeyListener {
	JFrame f;
	Graphics g;
	...
	public hardLevel()
	{
		...
		image5 = new ImageIcon("police.png");
		...
		car5Position = new JLabel(image5);
		...
		car5Position.setBounds(obs5x, obs5y, width, height);
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(((myCary >= obs5y) && (myCary<=obs5y+110)  || (myCary+140 >= obs5y) && (myCary +70 <= obs5y+140 ))&&(((obs5x>=myCarx) && (obs5x <= myCarx  +55 )) || ((obs5x+55>=myCarx)&&(obs5x+70<=myCarx+100))))
		{
			accident = 1 ;
		}
